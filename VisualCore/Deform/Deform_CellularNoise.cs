...
public class Deform_CellularNoise : MonoBehaviour
{
    ...
    [Title("Parts")]
    public CellularNoiseDeformer cellularNoiseDeformer;
    ...
    private void OnEnable()
    {
        ...
        if (!cellularNoiseDeformer)
        {
            cellularNoiseDeformer = GetComponent<CellularNoiseDeformer>();
        };

        cellularNoiseDeformer.Factor = frequencyCurve.Evaluate(0);
    }
    ...
    private void Update()
    {
        ...
        if (canUpdate)
        {
            ...
            cellularNoiseDeformer.Factor = eval;
        };

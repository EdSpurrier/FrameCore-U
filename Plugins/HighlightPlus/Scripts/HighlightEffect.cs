    ...
    public partial class HighlightEffect : MonoBehaviour {
            ...
            if (useSmoothBlend) {
                ...
                if ((glow > 0 && smoothGlowVisibility == Visibility.AlwaysOnTop) || (outline > 0 && smoothOutlineVisibility == Visibility.AlwaysOnTop)) {
                    if (Application.isMobilePlatform) {
                        ...
                        cbSmoothBlend.SetRenderTarget(sourceRT, RenderBufferLoadAction.Load, RenderBufferStoreAction.DontCare);
                    }
                } else {
                    if (Application.isMobilePlatform) {
                        cbSmoothBlend.SetRenderTarget(sourceRT, RenderBufferLoadAction.DontCare, RenderBufferStoreAction.DontCare, BuiltinRenderTextureType.CameraTarget, RenderBufferLoadAction.Load, RenderBufferStoreAction.DontCare);
                    } else {
        ...
        void ComposeSmoothBlend(Visibility smoothGlowVisibility, Visibility smoothOutlineVisibility) {
            ...
            if (renderSmoothGlow) {
                ...
                if (glowOptimalBlit) {
                    if (Application.isMobilePlatform) {
                        cbSmoothBlend.SetRenderTarget(BuiltinRenderTextureType.CameraTarget, RenderBufferLoadAction.Load, RenderBufferStoreAction.DontCare);
                    } else {
        ...
        void UpdateMaterialPropertiesNow() {
            ...
            maskRequired = outline > 0 || glow > 0 || seeThrough > 0;
